...
<div class="kg-system-page" data-page="system-home" data-system="desulfurization">
  <section class="kg-page-hero kg-shell" data-reveal="up">
    <div class="kg-breadcrumbs"><a href="{{ '/systems/' | relative_url }}">系统总览</a><span>/</span><strong>脱硫系统</strong></div>
  ...
  <section class="kg-shell kg-section" data-reveal="up">
    <div class="kg-section__head kg-section__head--wide">
      <div>
        <p class="kg-kicker">Layer Entry</p>
        <h2>层级入口</h2>
      </div>
      <p class="kg-muted">烟气脱硫、浆液循环、氧化结晶与副产物处理的主系统入口。</p>
    </div>
    <div class="kg-layer-entry" id="kg-layer-entry"></div>
  </section>
