---
permalink: /systems/desulfurization/
title: "脱硫系统"
author_profile: false
---

<div class="kg-system-page" data-page="system-home" data-system="desulfurization">
  <section class="kg-page-hero kg-page-hero--system kg-shell" data-reveal="up">
    <div class="kg-breadcrumbs"><a href="{{ '/' | relative_url }}">首页</a><span>/</span><strong>脱硫系统</strong></div>
    <div class="kg-system-hero" id="kg-system-hero"></div>
  </section>

  <section class="kg-shell kg-section kg-section--chapter-nav" data-reveal="up">
    <div class="kg-section__head kg-section__head--wide">
      <div>
        <p class="kg-kicker">Chapter Navigation</p>
        <h2>章节导航</h2>
      </div>
      <p class="kg-muted">沿着系统层、设备层、操作层和故障层顺序浏览，不再切换到独立子页面。</p>
    </div>
    <div class="kg-layer-anchor-grid" id="kg-layer-entry"></div>
  </section>

  <section class="kg-shell kg-system-dashboard" data-reveal="up">
    <div class="kg-panel">
      <div class="kg-panel__head"><p class="kg-kicker">Units</p><h2>系统单元</h2></div>
      <div id="kg-unit-grid" class="kg-unit-grid"></div>
    </div>
    <div class="kg-panel">
      <div class="kg-panel__head"><p class="kg-kicker">Interface</p><h2>工艺接口与测点</h2></div>
      <div class="kg-system-info-grid" id="kg-system-info-grid"></div>
    </div>
    <div class="kg-panel">
      <div class="kg-panel__head"><p class="kg-kicker">Focus</p><h2>运行关注</h2></div>
      <div class="kg-system-focus-grid" id="kg-system-focus-grid"></div>
    </div>
  </section>

  <section class="kg-shell kg-section kg-chapter" data-reveal="up" id="section-overview">
    <div class="kg-section__head kg-section__head--wide">
      <p class="kg-kicker">Overview</p>
      <div><h2>系统层</h2><p class="kg-muted">观察系统边界、单元划分和测点布置。</p></div>
    </div>
  ...
  <section class="kg-shell kg-section kg-chapter" data-reveal="up" id="section-equipment">
    <div class="kg-section__head kg-section__head--wide">
      <p class="kg-kicker">Equipment</p>
      <div><h2>设备层</h2><p class="kg-muted">聚焦设备簇、设备职责和关键观察点。</p></div>
    </div>
  ...
  <section class="kg-shell kg-section kg-chapter" data-reveal="up" id="section-operations">
    <div class="kg-section__head kg-section__head--wide">
      <p class="kg-kicker">Operations</p>
      <div><h2>操作层</h2><p class="kg-muted">围绕联锁、切换、投运顺序和控制目标展开。</p></div>
    </div>
  ...
  <section class="kg-shell kg-section kg-chapter" data-reveal="up" id="section-faults">
    <div class="kg-section__head kg-section__head--wide">
      <p class="kg-kicker">Faults</p>
      <div><h2>故障层</h2><p class="kg-muted">从现象到排查，再到处置优先级形成诊断路径。</p></div>
    </div>
